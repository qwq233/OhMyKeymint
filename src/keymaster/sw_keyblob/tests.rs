        ...
        (
            ...
            KeyBlob {
                ...
                sw_enforced: vec![
                    KeyParameter {
                        tag: Tag::ALGORITHM,
                        value: KPV::Algorithm(Algorithm::AES),
                    },
                    KeyParameter {
                        tag: Tag::KEY_SIZE,
                        value: KPV::Integer(128),
                    },
                    KeyParameter {
                        tag: Tag::PURPOSE,
                    ...
                    KeyParameter {
                        tag: Tag::ORIGIN,
                        value: KPV::Origin(KeyOrigin::GENERATED),
                    },
                    KeyParameter {
                        tag: Tag::OS_VERSION,
                        value: KPV::Integer(110000),
                    },
                    KeyParameter {
                        tag: Tag::OS_PATCHLEVEL,
                        value: KPV::Integer(202107),
                    },
                    KeyParameter {
                    ...
                    KeyParameter {
                        ...
                        value: KPV::Integer(20210705),
                    },
                    KeyParameter {
                        tag: Tag::BOOT_PATCHLEVEL,
                        value: KPV::Integer(0),
                    },
                ],
            },
        ...
        (
            ...
            KeyBlob {
                ...
                sw_enforced: vec![
                    KeyParameter {
                        tag: Tag::ALGORITHM,
                        value: KPV::Algorithm(Algorithm::EC),
                    },
                    KeyParameter {
                        tag: Tag::EC_CURVE,
                        value: KPV::EcCurve(EcCurve::P_521),
                    },
                    KeyParameter {
                        tag: Tag::PURPOSE,
                    ...
                    KeyParameter {
                        tag: Tag::DIGEST,
                        value: KPV::Digest(Digest::NONE),
                    },
                    KeyParameter {
                        tag: Tag::KEY_SIZE,
                        value: KPV::Integer(521),
                    },
                    KeyParameter {
                        tag: Tag::ORIGIN,
                        value: KPV::Origin(KeyOrigin::GENERATED),
        ...
        (
            ...
            KeyBlob {
                ...
                sw_enforced: vec![
                    ...
                    KeyParameter {
                        tag: Tag::DIGEST,
                        value: KPV::Digest(Digest::SHA_2_256),
                    },
                    KeyParameter {
                        tag: Tag::MIN_MAC_LENGTH,
                        value: KPV::Integer(256),
                    },
                    KeyParameter {
                        tag: Tag::ORIGIN,
                        value: KPV::Origin(KeyOrigin::GENERATED),
        ...
        (
            ...
            KeyBlob {
                ...
                sw_enforced: vec![
                    KeyParameter {
                        tag: Tag::ALGORITHM,
                        value: KPV::Algorithm(Algorithm::RSA),
                    },
                    KeyParameter {
                        tag: Tag::KEY_SIZE,
                        value: KPV::Integer(2048),
                    },
                    KeyParameter {
